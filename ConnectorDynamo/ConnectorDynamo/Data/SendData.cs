...
namespace Speckle.ConnectorDynamo.Data
{
  ...
  /// </summary>
  [NodeName("Send Data")]
  [NodeCategory("Speckle 2.Data.Actions")]
  ...
  [NodeSearchTags("send", "data", "stream", "speckle")]
  [IsDesignScriptCompatible]
  public class SendData : NodeModel
  {
    #region fields & props
    ...
    [JsonConstructor]
    private SendData(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(inPorts, outPorts)
    {
      if (inPorts.Count() == 3)
      {
    ...
    private void AddOutputs()
    {
      OutPorts.Add(new PortModel(PortType.Output, this,
        new PortData("streamUrl", "Stream(s) pointing to the created commit.")));
    }
