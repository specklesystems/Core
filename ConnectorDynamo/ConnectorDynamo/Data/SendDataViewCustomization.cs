...
{
  public class SendDataViewCustomization : INodeViewCustomization<SendData>
  {
    private DynamoViewModel dynamoViewModel;
    private DispatcherSynchronizationContext syncContext;
    private SendData sendNode;
    private DynamoModel dynamoModel;
    private NodeView _nodeView;
    private List<MenuItem> customMenuItems = new List<MenuItem>();

    public void CustomizeView(SendData model, NodeView nodeView)
    {
      _nodeView = nodeView;
