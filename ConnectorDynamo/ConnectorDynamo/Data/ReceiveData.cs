...
namespace Speckle.ConnectorDynamo.Data
{
  /// <summary>
  /// Receive data from Speckle
  /// </summary>
  [NodeName("Receive Data")]
  ...
  public class ReceiveData : NodeModel
  {
    ...
    [JsonConstructor]
    private ReceiveData(IEnumerable<PortModel> inPorts, IEnumerable<PortModel> outPorts) : base(inPorts, outPorts)
    {
      if (inPorts.Count() == 1)
      {
    ...
    {
      InPorts.Add(new PortModel(PortType.Input, this, new PortData("streamUrl", "URL of the Speckle stream to receive data from. Can be the URL of a stream, branch or commit or object.")));
    }

    private void AddOutputs()
    {
      OutPorts.Add(new PortModel(PortType.Output, this, new PortData("data", "Data received from the Speckle stream.")));
      OutPorts.Add(new PortModel(PortType.Output, this, new PortData("info", "Information about the specific commit your data was retrieved from.")));
    }
