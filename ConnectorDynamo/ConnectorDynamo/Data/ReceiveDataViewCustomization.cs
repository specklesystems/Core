...
{
  public class ReceiveDataViewCustomization : INodeViewCustomization<ReceiveData>
  {
    private DynamoViewModel dynamoViewModel;
    private DispatcherSynchronizationContext syncContext;
    private ReceiveData receiveNode;
    private NodeView _nodeView;
    private DynamoModel dynamoModel;
    private MenuItem viewStreamMenuItem;

    public void CustomizeView(ReceiveData model, NodeView nodeView)
    {
      _nodeView = nodeView;
