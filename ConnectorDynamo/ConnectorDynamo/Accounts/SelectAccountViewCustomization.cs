...
{
  public class SelectAccountViewCustomization : INodeViewCustomization<SelectAccount>
  {

    private DynamoViewModel dynamoViewModel;
    private DispatcherSynchronizationContext syncContext;
    private SelectAccount accountsNode;
    private DynamoModel dynamoModel;

    public void CustomizeView(SelectAccount model, NodeView nodeView)
    {
